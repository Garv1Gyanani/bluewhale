...
class DataTank extends WhaleRouteAwareTank {
  ...
  void didPush(Route<dynamic> route, Route<dynamic>? previousRoute) {
    ...
    final msg = "Pushed: ${route.settings.name}, Prev: ${previousRoute?.settings.name ?? 'none'}";
    ...
    if (route.settings.name == '/details') {
        print("DataTank: Details page pushed, maybe fetch detail-specific data...");
    }
  }
  ...
  void didPop(Route<dynamic> route, Route<dynamic>? previousRoute) {
    ...
    final msg = "Popped: ${route.settings.name}, New Top: ${previousRoute?.settings.name ?? 'none'}";
    print("DataTank (RouteAware): $msg");
    routeEventLog.value = msg;
  }
  ...
  void didReplace({Route<dynamic>? newRoute, Route<dynamic>? oldRoute}) {
    ...
    final msg = "Replaced: New: ${newRoute?.settings.name ?? 'none'}, Old: ${oldRoute?.settings.name ?? 'none'}";
    print("DataTank (RouteAware): $msg");
    routeEventLog.value = msg;
  }
