          ...
          child: Column(
            ...
            children: [
              Text(
                  'page_arguments'
                      .bwTr(context)
                      .replaceAll('{args}', argsDisplay),
                  style: Theme.of(context).textTheme.titleMedium),
              const SizedBox(height: 20),
              Text(
                'route_aware_log'
                    .bwTr(context)
                    .replaceAll('{event}', dataTank.routeEventLog.value),
              ...
              ElevatedButton(
                onPressed: () => Whale.back(result: "Returned from Details!"),
